...
const finalCode = eval(`function edit() { \n${codeBlock}\n readMe.status = "${status.message}"; readMe.activity = "${activity.message}"; readMe.location = "${location}"; readMe.stats = () => { return "This repository has ${stargazers_count} stars with ${followers} followers" };  return readMe }; edit()`);
