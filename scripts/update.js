...
const finalCode = eval(`function edit() { \n${codeBlock}\n readMe.status = "${status.message}"; readMe.activity = "${activity.message}"; readMe.location = "${location}"; readMe.followersCount = "${followers}"; readMe.stats = () => { return "This repository has ${stargazers_count} stars." };  return readMe }; edit()`);
